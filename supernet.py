...
def ip_to_binary_visual(network):
    ...
    the network bits in bold and host bits
    """
    try:
        net_obj = ipaddress.ip_network(network, strict=False)
...
def create_prefix_mask(prefix_len, total_len=32):
    ...
    Example: prefix_len=24 returns "11111111.11111111.11111111.........."
    """
...
def create_prefix_binary_mask(network_obj):
    ...
    Example: for 192.168.0.0/16 returns "11111111.11111111.00000000.00000000"
    """
...
def get_common_prefix(networks):
